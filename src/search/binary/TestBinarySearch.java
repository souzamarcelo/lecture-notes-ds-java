...
import search.sequential.GenericSequentialEntrySearch;
import search.sequential.GenericSequentialSearch;
import search.sequential.SimpleSequentialSearch;

public class TestBinarySearch {
	
	public static void main(String[] args) {
		System.out.println("Simple search test...");
		SimpleBinarySearch simpleSearch = new SimpleBinarySearch();
		...
		String[] stringArray = {"Argentina", "Brasil", "Canadá", "França", "Japão"};
		...
		studentList.add(1, new Student("João", 20));
		studentList.add(2, new Student("José", 53));
		studentList.add(3, new Student("Maria", 33));
		...
		GenericBinarySearch<Student> searchStudent = new GenericBinarySearch<>();
		...
		entryList.add(1, new TestEntry<MyKey, Product>(new MyKey(3, 4), new Product("Calça", 170d)));
		entryList.add(2, new TestEntry<MyKey, Product>(new MyKey(3, 6), new Product("Tênis", 280d)));
		entryList.add(3, new TestEntry<MyKey, Product>(new MyKey(2, 8), new Product("Jaqueta", 450d)));
		System.out.println(entryList.toString());
		
		GenericBinaryEntrySearch<MyKey, Product> searchEntry = new GenericBinaryEntrySearch<>();
